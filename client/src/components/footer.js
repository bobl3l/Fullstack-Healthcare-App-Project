...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-slate-200 pb-10 pt-20 lg:pb-20 lg:pt-[120px]">
            ...
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <div className="flex items-center text-sm font-medium text-dark ">
                  ...
                  <span> +44 1234 67899</span>
                </div>
              </div>
            </div>

            <LinkGroup header="Resources">
              <NavLink link="/#" label="Doctor Information" />
              <NavLink link="/#" label="Our Services" />
              <NavLink link="/#" label="User Flow" />
              <NavLink link="/#" label="User Strategy" />
            </LinkGroup>
            <LinkGroup header="Company">
              <NavLink link="/#" label="About MyDoctor" />
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <div className="mb-6 flex items-center">
                  {" "}
                  <div className="mx-10"></div>
                  <a className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark hover:border-primary hover:bg-primary hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                    <svg
                      width="8"
                      height="16"
                      viewBox="0 0 8 16"
